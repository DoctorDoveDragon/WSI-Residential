...
Each standalone form includes:
  ...
  - A footer noting the source manual (Rev. 2.12) and the form's purpose
...
def _standalone_form_doc(filepath, title):
    ...
    return SimpleDocTemplate(
        ...
        creator='Z.ai',
        subject=f'{title} — Rev. 2.12 (RMDM-Compliant)',
    )
...
def build_form_6(filepath):
    ...
    story.append(Paragraph(
        ...
        'SOP Manual for <b>Well Spring Intervention LLC</b> (Rev. 2.12, July 2026, '
