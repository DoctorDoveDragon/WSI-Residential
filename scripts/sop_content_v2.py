...
def build_part1():
    ...
    story.append(para(
        'Pursuant to <b>NC Medicaid Clinical Coverage Policy 8D-2, "Residential Treatment '
    ...
    story.extend(bullets([
        ...
        'Consistent with this, the facility is licensed under <b>NCGS Chapter 122C</b> by NC '
        'DHSR MHLC — not under NCGS Chapter 131D by DSS, which licenses foster-care family '
    ...
    story.append(para(
        ...
        'defined <b>inpatient</b> benefit under 42 CFR Part 483, Subpart G (§§ 483.350–'
        ...
        'facility is <b>not</b> a PRTF; it is a Level III RTS under CCP 8D-2, and the room-'
    ...
    story.append(para(
        ...
        '<b>inpatient</b> facility benefit under 42 CFR Part 483, Subpart G; the PRTF '
    ...
    story.append(para(
        ...
        '&bull; <b>10A NCAC 13F .0309 Family Care Home Fire Safety (NC DHSR)</b> — '
        'https://info.ncdhhs.gov/dhsr/rules/2025/AdultCareHomeFamilyCareHomeRules/feb/10A_NCAC_13F_.0309.pdf<br/>'
        '&bull; <b>10A NCAC 13G .0316 Adult Care Home Fire Safety (NC DHSR)</b> — '
