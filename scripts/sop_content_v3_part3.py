...
def build_part3():
    ...
    story.append(Paragraph(
        ...
        'SOP Manual for <b>Well Spring Intervention LLC</b> (Rev. 2.21, July 2026, '
        'RMDM-Compliant). I understand these policies are mandated by NC DHSR, '
        'NC Medicaid, our accrediting body, the NCDHHS Records '
        'Management and Documentation Manual (Effective July 8, 2025), state law on '
        'electronic transactions (NC UETA) and the federal E-SIGN Act governing electronic signatures. '
        ...
        '§1.4(b) per our operating standards — there are two acceptable pathways: Pathway 1 '
    ...
    vh_rows = [
        ...
        ['2.16', 'Jul 2026',
         ...
         'Executive Director / QP'],
        ['2.17', 'Jul 2026',
         'New §9.4 Two-Story &amp; Multi-Level Facility Requirements added to SOP 9 (Facility, Safety, &amp; Environmental Management). New subsection codifies the regulatory requirements specific to two-story group homes: §9.4(a) applicability and DHSR licensing-notification triggers (relocating youth bedrooms upstairs, increasing upper-floor capacity, converting single-story to two-story, housing non-ambulatory youth upstairs); §9.4(b) means of egress per NC OSFM Building Code §425, NC Fire Code Ch. 10, and IBC 2021 §1030 (5.7 sq ft / 24 in / 20 in / 44 in sill emergency-escape openings, two remotely-located means of egress per occupied story, stair geometry, emergency-backup stair lighting, chain-style fire-escape ladders in each second-floor youth bedroom); §9.4(c) per-floor fire detection, suppression, and alarm (interconnected smoke detectors on all levels per NFPA 72, CO detectors on every floor with fuel-burning appliances and within 10 ft of sleeping rooms, automatic sprinklers per NFPA 13D/13R, 2A-10BC extinguishers per level with 75-ft max travel); §9.4(d) per-floor staff supervision (awake overnight DCP positioned to cover upper-floor hallway, 15-minute room checks physically performed on every sleeping floor and documented on Form 1, stair safety gates at top and bottom for youth under 12 or with elopement/suicidality risk, baby-monitor/intercom option with documented 60-second response time); §9.4(e) window fall protection (restrictors limiting opening to ≤4 in. where second-floor sill is &lt;24 in. above floor, staff-key releasable, monthly function check on Form 5); §9.4(f) vertical-evacuation drills (monthly fire drills must include full evacuation from all second-floor sleeping rooms to grade, quarterly tornado drills use lowest interior level only — no second-floor bathrooms); §9.4(g) bedroom placement policy (lower-acuity/lower-mobility/younger youth on ground floor; no attic/basement bedrooms; placement documented in PCP); §9.4(h) posted evacuation maps and stair hazard signage on each floor. Each requirement carries inline hyperlinked web-source citations to the underlying NC Administrative Code , NC OSFM Building Code §425, NC Fire Code 2024 Ch. 10, NC IFC 2021 Ch. 4, IBC 2021 §1030, NC DHSR ACLS Family Care Home licensing and Fire Safety training PDFs, NFPA 101 Life Safety Code (Board &amp; Care §32/33), Durham NC and Orange County NC smoke/CO alarm summaries, NCSL CO Detector Statutes, and the NC Family Care Home structure rule (no more than 2 stories; second-floor residents require two direct exterior egress). Form 1 (Shift Change &amp; Awake Night Watch Log) is extended with a new "Per-Floor Walk-Through Certification" sub-table requiring the awake overnight DCP to initial Floor 1, Floor 2, and Basement walk-throughs every 2 hours (4 time blocks: 11p-1a, 1a-3a, 3a-5a, 5a-7a) — single-story facilities mark N/A. Form 5 (Environmental Safety Log) is extended with a new "Two-Story / Multi-Level Per-Floor Safety Checks" sub-table with three floor rows (Floor 1 / Floor 2 / Basement) and eight check columns (Smoke Detectors, CO Detectors, Extinguisher, Egress Window / Escape Ladder, Window Restrictor ≤4 in., Stair Gate, plus Staff Initials) completed monthly. Form 6 (Employee SOP Acknowledgment) Rev. reference updated from 2.16 to 2.17. All other body content (SOPs §1-§8, §10-§11, Protocol 22 Daily Workflow Schedules, §1.4(b) QP Credentialing Requirements, and all other forms) is unchanged from Rev. 2.16.',
         'Executive Director / QP'],
        ['2.18', 'Jul 2026',
         '<b>LICENSE CATEGORY CORRECTION</b> — Level III Residential Treatment Facility (Staff-Secure for Children and Adolescents) under our operating standards. Prior revisions incorrectly identified the facility as a "Level 3 Supervised Residential Group Home" under 27G .5600; the correct license category per organizational direction is <b>Level III RTF Staff-Secure</b> under <b>our operating standards</b>, issued by NC DHSR Mental Health Licensure &amp; Certification Section (MHLC), credentialed with <b>Alliance Health</b> as the LME/MCO/Tailored Plan. <b>Major content changes:</b> (1) §1.2 rewritten for correct license category, naming DHSR MHLC and Alliance Health, plus four new sub-subsections: §1.2(a) Accreditation Prerequisite (COA/TJC/CARF/CQL per the Resident Rights framework); §1.2(b) LME/MCO Letter of Support per the Resident Rights framework.1; §1.2(c) Certificate of Need (CON) Determination per state law Ch. 131E Art. 9; §1.2(d) Alliance Health Provider Network Application. (2) §1.4 updated to use QP/QMHP interchangeably per 27G .2600. (3) NEW §1.7 Resident Rights &amp; Dignity per the Resident Rights framework. (4) NEW §1.8 Organizational &amp; Financial Foundations (Articles of Incorporation, governing body roster, liability insurance, lease/deed, financial solvency). (5) §2.1 STAFFING RATIO CRITICAL FIX — replaced 1:4 day / 1:8 overnight with <b>2 staff minimum for 1–4 youth 24/7</b> per 27G .2600, scaling to 4 staff for 5–8 youth and 5 staff for 9 youth. (6) NEW §2.5(a) CEU tracking per licensed clinical staff. (7) NEW §2.6 Staff Leave &amp; Time-Off Policy per 27G .0203(e). (8) §3 ADMISSION PHYSICAL EXAM CRITICAL FIX — replaced "within 30 days of admission" with <b>"within 90 days PRIOR to admission"</b> per 27G .2600. (9) NEW §5.5 Activities Program (minimum 14 hrs/week planned group activities per 27G .2600(c)). (10) NEW §6.5 Infection Control Program per CDC, 27G .0209, OSHA BBP (29 CFR 1910.1030). (11) NEW §7.3 Facility-Based School Determination (required for PRTF, not for Level III RTF). (12) NEW §9.5 Staff-Secure Physical-Plant Measures (controlled access, delayed egress, line-of-sight, visitor mgmt, contraband search). (13) NEW §9.6 Zoning Compliance (Fair Housing Act, NC Group Homes Act state law §160D-906). (14) NEW §9.7 Disaster &amp; Emergency Plan (fire, tornado, hurricane, power outage, system failure, lockdown, emergency relocation). (15) Protocol 19 in Part 2 expanded (hurricane, power outage, emergency relocation); all .5600 → .2600; overnight staffing updated from 1:8 to 2:4. (16) Form 6 Rev. reference updated from 2.17 to 2.18. Cover subtitle updated to "Level III Residential Treatment Facility (Staff-Secure)". Seal artwork (Rev. 2.15) unchanged.',
         'Executive Director / QP'],
        ['2.19', 'Jul 2026',
         '<b>APPLICATION-PROCEDURE &amp; SURVEY-READINESS PATCH</b> — addresses specific items in the user-supplied 7-phase Level III RTF opening checklist that v2.18 did not yet make explicit. <b>Phase 3 (License Application):</b> NEW §1.2(e) DHSR MHLC License Application Procedure — names the <b>DHHS/DHSR/MHL 5001 Initial Licensure Application Form</b>, cover letter requirement, complete application packet contents (local approvals, accreditation, Letter of Support, CON determination, corporate documents, P&amp;P Manual, fee), assignment of a <b>Licensure &amp; Training Consultant</b>, and the <b>six (6) month application-review period beginning at the first in-person meeting with the Consultant</b>. NEW §1.2(f) MH Licensure Policies &amp; Procedures Worksheet — clarifies that the Worksheet is a crosswalk, not a substitute for the rules; must be completed, attached to the front of this Manual, and updated whenever any Manual section is revised. <b>Phase 4 (Policies, Procedures &amp; Personnel):</b> §2.3 background checks updated to explicitly state the <b>180-day criminal background check</b> window and the <b>90-day Health Care Personnel Registry check</b> window prior to licensure review (and annually thereafter); new Background Check Expiration Tracking Log; §2.4 mandatory training expanded to explicitly include <b>CPR with Heimlich Maneuver (in-person only)</b>, <b>Population-Specific Training</b> (children/adolescents with SED), <b>Alternatives to Restrictive Interventions (De-Escalation)</b>, <b>Seclusion/Physical Restraint/Isolation Time-Out (in-person only)</b>, <b>Client Rights &amp; Confidentiality</b>, and <b>General Organization Orientation</b>; all in-person-only training items so marked. NEW §2.7 Instructor Credentials &amp; Trainer Certifications — AHA BLS Instructor / Red Cross Instructor for CPR/First Aid; NCI Instructor or CPI Certified Instructor for restraint/de-escalation; RN with NC-DHHS Medication Administration Trainer course for med admin; documentation of instructor name, certification body, number, issue/expiry dates, and training sessions delivered; expired-instructor training is invalid. <b>Phase 5 (Emergency &amp; Disaster Preparedness):</b> NEW §9.7(0) Coordination with Local Office of Emergency Management (OEM) — submit Disaster Plan to local OEM, obtain written acknowledgment, confirm 9-1-1 dispatch address and special-needs registry enrollment, with link to NC Emergency Management directory. <b>Phase 6 (Licensure Survey):</b> NEW §10.10 Mock Client Chart &amp; Licensure Survey Readiness — 14-element Mock Client Chart (Face Sheet, Emergency Info, Consents, CCA, PCP, Progress Notes, Medication Orders/MAR, BSP, Restrictive-Intervention Records, Health Records, Activities Log, Grievance Records, Disclosures, Discharge Plan); labeled facility photographs; full document assembly for surveyor review; mandatory mock survey 30 days prior. <b>Phase 7 (Medicaid Enrollment):</b> NEW §1.9 Medicaid Enrollment &amp; NCTracks (Post-Licensure) — Type 2 NPI for organization via NPPES; NCTracks Provider Enrollment; <b>Provider Permission Matrix (PPM)</b> selection; <b>taxonomy 320800000X — Residential Treatment Facility, Children</b> (or 320900000X for dual-diagnosis); post-enrollment accreditation timeline (1 year or 3 years); 12-month re-attestation; with hyperlinks to NPPES, NCTracks, NC Medicaid Tailored Plan Provider Manual, and NUCC taxonomy code set. Form 6 Rev. reference updated from 2.18 to 2.19. All other body content unchanged from Rev. 2.18.',
         'Executive Director / QP'],
        ['2.20', 'Jul 2026',
         '<b>NC MEDICAID RTS TAXONOMY PATCH + CITATION-VERIFICATION COMPLIANCE FLAG</b> — adds the three explicit NC Medicaid Residential Treatment Services taxonomy items the user asked to confirm, AND transparently flags two citation discrepancies that the QP must resolve with DHSR MHLC and Alliance Health before initial licensure submission. <b>Confirmed via NC Medicaid Clinical Coverage Policy 8D-2 (Amended January 1, 2025) §1.0(c):</b> (i) Setting type = "program setting only" (not a family home) — graduated hierarchy across RTS Levels I–IV where Level III uses "program setting <i>only</i>"; (ii) Structure/supervision = "highly structured and supervised" — staff-secure, continuous awake overnight supervision; (iii) Coverage scope = room and board EXCLUDED from the Medicaid RTS benefit category (applies to all four RTS levels). NEW §1.2(g) NC Medicaid RTS Taxonomy — Setting Type, Supervision Intensity &amp; Coverage Scope — explicit bullet statement of all three items with verbatim quotes from CCP 8D-2 §1.0(c) and Attachment D (Section K); operational implementation cross-references (2:4 ratio per §2.1, line-of-sight per §9.5, 14-hr activities per §5.5, BSP per §5.3, awake overnight per Protocol 22); PRTF distinction paragraph noting that 8D-2 exclusion does NOT apply to PRTFs Under our operating standards, Subpart G / CCP 8D-1 (inpatient benefit, per-diem includes room-and-board-equivalent); hyperlink citations to CCP 8D-2, NC Medicaid Managed Care Health Plan Billing Guide v31, 42 CFR Part 483 Subpart G, and CCP 8D-1. NEW §1.2(h) Regulatory Citation Verification Note (Compliance Flag) — transparent flag for review by Executive Director, QP, licensing consultant, DHSR MHLC, and Alliance Health; flags (a) our operating standards vs .1700 — NC OAH publication shows .2600 as "Reserved for Future Codification"; operative Level III Staff-Secure section appears to be .1700 ; Manual continues to cite .2600 per organization direction pending written confirmation from Licensure &amp; Training Consultant; (b) NC Medicaid "CCP 8C" vs "CCP 8D-2" — CCP 8C is "Outpatient Behavioral Health Services Provided by Direct-Enrolled Providers" (wrong benefit); correct RTS policy is CCP 8D-2; Manual continues to cite CCP 8C in legacy reference lines pending Alliance Health/NCTracks enrollment confirmation; (c) No operational impact — license category, staffing ratios, admission exam timing, resident rights, Medicaid taxonomy, and room-and-board exclusion all unchanged. Resolution of either citation item shall be documented in a v2.21 revision. §1.9 Medicaid Enrollment updated — explicit enrollment under CCP 8D-2 (not 8C or 8D-1); cross-reference to §1.2(g) for room-and-board exclusion; verification of non-Medicaid room-and-board funding source at admission and at each PCP review. §10.9 Billing updated — explicit CCP 8D-2 citation; Medicaid RTS per-diem covers ONLY clinical/treatment/milieu component; room and board EXCLUDED; non-Medicaid funding sources enumerated (state/local social-services funds, Title IV-E foster care maintenance, SSI/ISS, third-party resources); under no circumstances shall room-and-board costs be billed to Medicaid/Alliance Health/NCTracks; suspected improper billing reported to Compliance Officer per §1.3 and corrected via NCTracks claim adjustment within 30 days. §3.1 Admission Criteria updated — adds verbatim "highly structured and supervised environment in a program setting only, excluding room and board" language per CCP 8D-2 §1.0(c); QP verification of non-Medicaid room-and-board funding source at admission. §7.3 Facility-Based School Determination updated — adds explicit CCP 8D-2 (RTS) vs CCP 8D-1 (PRTF) Medicaid benefit distinction; PRTF per-diem includes room-and-board-equivalent (inpatient benefit); 8D-1 and 8D-2 mutually exclusive for same youth same day; future PRTF pathway adds NCTracks enrollment update step (8D-2 → 8D-1). Form 6 Rev. reference updated from 2.19 to 2.20.',
         'Executive Director / QP'],
        ['2.21', 'Aug 2026',
