...
def main():
    ...
    writer.add_metadata({
        ...
        '/Producer': 'http://z.ai',
        '/Subject':  subject_str,
        '/Keywords': 'SOP, residential group home, Level 3, operations manual, trauma-informed care, RMDM, HIPAA, 42 CFR Part 2, E-SIGN, Electronic Signatures, fillable forms, daily workflow schedules, legislation-free public edition',
    })
