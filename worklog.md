...
Task ID: SOP-59
Agent: main (Super Z)
Task: Revert the Level III Residential Treatment Facility (Hardware-Secure) calibration applied in SOP-58 and re-calibrate the WSI CARF CYS 2026 Conformance Plans portfolio to the user-corrected service type: Staff Secure Group Home. The Level III RTF designation was an error; the program is a Staff Secure Group Home (a less acute level of residential care that does not require the hardware-secure physical plant or on-site intensive clinical staffing of a Level III RTF).

Work Log:
- Audited existing /home/z/my-project/download/WSI_CARF_CYS_2026_Conformance_Plans.pdf (Rev. 1.1, 49 pages, 5.19 MB) for Level III RTF references that needed reverting. Identified 8 spots in carf_plans_content.py + 6 Rev 1.1 references in generate_carf_plans.py + 2 in carf_plans_cover.html + 2 in merge_carf_plans.py.
- Wrote /home/z/my-project/scripts/patch_carf_plans_v1_2.py — single patch script applying 18 surgical patches in one pass (8 to content, 6 to generate, 2 to cover, 2 to merge). All 18 patches succeeded on first run (vs SOP-58 which needed 2 patch scripts + 1 manual Edit due to multi-line string-literal matching issues — this time I read the actual source code first to get the exact old_str boundaries right).
- Verified all syntax via ast.parse on carf_plans_content.py, generate_carf_plans.py, merge_carf_plans.py — all OK.
- Verified stale-reference removal in carf_plans_content.py: "Level III RTF" → 0; "10A NCAC 27G .1703" → 0; "controlled-egress" → 0; "1:4 direct-care" → 0; "1:3 for high-acuity" → 0; "psychiatrist provides on-site coverage" → 0; "on-site Licensed Professional" → 0.
- Verified new-reference presence in carf_plans_content.py: "Staff Secure Group Home" → 6; "staff-secure group home" → 3; "1:6 direct-care" → 1; "Licensed Professional (LP)" → 1; "continuous staff supervision" → 5.
- Note: 1 occurrence of "Level III Residential Treatment Facility" + 2 occurrences of "hardware-secure" remain in carf_plans_content.py — these are intentional contrasts in the new Staff Secure Group Home text (Plan 3 §3.4 Licensure bullet and Plan 11 §11.2 Populations Served) that explicitly state the program serves youth who do NOT require the Level III RTF hardware-secure level of care. Verified via grep -B1 -A2 that the context is correct.
- The 8 carf_plans_content.py patches:
  * Plan 1 §1.4 (Populations & Services): replaced "Level III Residential Treatment Facility (hardware-secure, intensive clinical)" with "staff-secure group home setting"; replaced "24-hour residential treatment in a Level III RTF licensed under 10A NCAC 27G .1703" with "24-hour supervised residential care in a Staff Secure Group Home licensed under 10A NCAC 27G"; replaced "individual therapy (minimum 2 sessions/week), group therapy (daily), family therapy (minimum weekly)" with "individual therapy (minimum weekly), group therapy (multiple times per week), family therapy (as clinically indicated, minimum biweekly)"; replaced "on-site psychiatric coverage and 24/7 on-call psychiatric consultation" with "psychiatric consultation per the Person-Centered Plan schedule and on-call psychiatric consultation for urgent clinical concerns"; replaced "line-of-sight supervision capability for high-acuity residents" with "continuous staff supervision".
  * Plan 3 §3.4 (Licensure bullet): replaced "Level III Residential Treatment Facility (Hardware-Secure) license issued by NC DHHS under 10A NCAC 27G .1703" with "Staff Secure Group Home license issued by NC DHHS under 10A NCAC 27G"; replaced "Level III is the highest-acuity NC RTF category..." with "The Staff Secure Group Home level of care serves children and adolescents with serious emotional disturbance who require 24-hour supervised residential care with structured clinical services and continuous staff supervision, but who do not require the intensive, hardware-secure level of care provided in a Level III Residential Treatment Facility."
  * Plan 5 §5.4 (Enterprise Risk Register, elopement row): re-scored likelihood 2→3 and impact 5→4 (staff-secure physical plant has higher elopement likelihood than hardware-secure, but lower acuity population has lower impact per elopement event); replaced "Hardware-secure Level III RTF physical plant with controlled-egress doors (key-card / staff-controlled); alarmed perimeter; awake overnight line-of-sight supervision" with "Staff-secure group home with continuous staff supervision; awake overnight staff; elopement risk assessment at admission & weekly; staff protocol for missing-resident response; community-search procedure; police notification within 30 min if not located".
  * Plan 11 §11.2 (Populations Served): replaced "Level III Residential Treatment Facility (hardware-secure, intensive clinical)" with "staff-secure group home setting"; replaced "clinical acuity exceeds what can be safely managed in a less restrictive Level I or Level II residential setting" with "do not require the intensive, hardware-secure level of care provided in a Level III Residential Treatment Facility".
  * Plan 11 §11.3 (Service Array, residential care bullet): replaced "24-hour intensive residential treatment in a Level III RTF (hardware-secure) licensed under 10A NCAC 27G .1703" with "24-hour supervised living in a Staff Secure Group Home licensed under 10A NCAC 27G".
  * Plan 11 §11.5 (Staffing Patterns): major recalibration — replaced "1:4 direct-care staff-to-resident ratio during waking hours (1:3 for high-acuity residents on line-of-sight supervision), and a minimum 1:8 ratio overnight" with "1:6 direct-care staff-to-resident ratio during waking hours, and a minimum 1:8 ratio overnight"; replaced "Licensed Professional (LP) is on-site a minimum of 16 hours per day, 7 days per week" with "Licensed Professional (LP) is on-site during business hours and on call 24/7 for clinical emergencies"; replaced "board-certified psychiatrist provides on-site coverage per the medication-management schedule and is on call 24/7 for psychiatric emergencies" with "psychiatrist is available for medication-management appointments per the Person-Centered Plan schedule and is on call for urgent psychiatric consultation"; replaced "Registered Nurse (RN) is on-site or on call 24/7 for medical and medication-related needs" with "Registered Nurse (RN) is available on-site per the medication-management and health-services schedule and on call for urgent medical needs".
  * Plan 11 §11.6 (Physical Environment): replaced "designed and licensed as a Level III Residential Treatment Facility (Hardware-Secure) under 10A NCAC 27G .1703" with "designed and licensed as a Staff Secure Group Home under 10A NCAC 27G"; removed all hardware-secure features (controlled-egress doors, alarmed perimeter video monitoring, secured visitor vestibule) and replaced with staff-secure features ("continuous staff supervision of residents, staff-monitored entry and exit (doors may be locked to elopement risk with staff-controlled release), door and window alarms as appropriate to the resident population, and a controlled visitor-entry process"); removed "controlled-egress perimeter" from outdoor recreation area; removed "hardware-secure facility requirements under .1703" from code-compliance sentence.
  * Plan 12 §12.4 (Screening Criteria, clinical acuity): replaced "requires the Level III RTF level of care — i.e., hardware-secure, intensive clinical services with 24-hour on-site Licensed Professional availability and psychiatric on-call, and whose acuity exceeds what can be safely managed in a less restrictive Level I or II setting" with "requires the staff-secure group home level of care — i.e., 24-hour supervised residential care with structured clinical services and continuous staff supervision, and whose needs cannot be safely met in a less restrictive community-based setting".
- The 6 generate_carf_plans.py patches: DOC_TITLE_SHORT, TOC intro doc-id, PDF subject metadata, About-page intro, About-page Document ID line (all Rev 1.1→1.2) + About-page Service Type + Service Intensity replacement.
- About-page Service Type line now reads: "Staff Secure Group Home — 10A NCAC 27G."
- About-page Service Intensity line now reads: "The Staff Secure Group Home provides 24-hour supervised residential care for children and adolescents with serious emotional disturbance who require structured clinical services and continuous staff supervision, but whose needs can be safely met without the hardware-secure physical plant and on-site intensive clinical staffing of a Level III Residential Treatment Facility. Features include staff-supervised egress (doors may be locked to manage elopement risk), continuous staff supervision, awake overnight staff, minimum 1:6 direct-care staff-to-resident ratio during waking hours and 1:8 overnight, Licensed Professional on-site during business hours and on-call 24/7, psychiatrist available per the Person-Centered Plan medication-management schedule, RN available per the health-services schedule and on-call for urgent medical needs, individual therapy minimum weekly, group therapy multiple times per week, family therapy as clinically indicated, and Person-Centered Plan reviews at minimum every 90 days or as clinically indicated."
- Cover scope-pill now reads: "Staff Secure Group Home · Inaugural One-Year Accreditation · 2026 CYS Standards"; document-id shows "WSI-CARF-PLANS-001 · Rev. 1.2".
- merge_carf_plans.py: PDF Subject metadata Rev 1.2; print message Rev 1.2.
- Regenerated body PDF via `python3 generate_carf_plans.py` → carf_plans_body.pdf.
- Regenerated cover PDF via `NODE_PATH=/home/z/.npm-global/lib/node_modules node html2poster.js carf_plans_cover.html --output carf_plans_cover.pdf --width 794px` → carf_plans_cover.pdf (5.0 MB).
- Merged cover + body via `python3 merge_carf_plans.py` → final PDF: /home/z/my-project/download/WSI_CARF_CYS_2026_Conformance_Plans.pdf (49 pages, 5.19 MB, Rev. 1.2).
- Ran pdf_qa.py --skip-cover: 12/12 checks PASS (Title/Author/Creator metadata present, page size consistent 210mm×297mm, no blank pages, all fonts embedded, no content overflow, content fill ratio adequate, cover full-bleed, margins symmetric, table centering complete, TOC populated). 5 minor warnings on em-dash line-start punctuation (acceptable prose style).
- Verified via pdftotext -layout extraction: Cover scope-pill reads "STAFF SECURE GROUP HOME · INAUGURAL ONE-YEAR ACCREDITATION · 2026 CYS STANDARDS". About page shows "Service Type. Staff Secure Group Home — 10A NCAC 27G." and the new Service Intensity paragraph. Plan 1 §1.4 reads "staff-secure group home setting" + "24-hour supervised residential care in a Staff Secure Group Home licensed under 10A NCAC 27G". Plan 3 §3.4 Licensure bullet reads "Staff Secure Group Home license issued by the NC Department of Health and Human Services under 10A NCAC 27G". Plan 5 §5.4 elopement row reads "Staff-secure group home with continuous staff supervision; awake overnight staff; elopement risk assessment at admission & weekly; staff protocol for missing-resident response". Plan 11 §11.5 Staffing Patterns reads "1:6 direct-care staff-to-resident ratio during waking hours, and a minimum 1:8 ratio overnight" and "Licensed Professional (LP) is on-site during business hours and on call 24/7 for clinical emergencies". Plan 11 §11.6 reads "designed and licensed as a Staff Secure Group Home under 10A NCAC 27G" with "continuous staff supervision of residents, staff-monitored entry and exit...door and window alarms as appropriate...controlled visitor-entry process". Plan 12 §12.4 reads "requires the staff-secure group home level of care — i.e., 24-hour supervised residential care with structured clinical services and continuous staff supervision".
- Verified 0 stale Level III RTF references in final PDF text: 0 occurrences of "Level III RTF", "10A NCAC 27G .1703", "controlled-egress", or "1:4 direct-care". (Note: 2 intentional "Level III Residential Treatment Facility" + "hardware-secure" mentions remain in Plan 3 §3.4 and Plan 11 §11.2 as explicit contrasts — "do not require the intensive, hardware-secure level of care provided in a Level III Residential Treatment Facility" — which is the correct clinical framing for a staff-secure group home program.)

Stage Summary:
- Final deliverable: /home/z/my-project/download/WSI_CARF_CYS_2026_Conformance_Plans.pdf — 49 pages, 5.19 MB, Rev. 1.2 (August 2026)
- All 15 written plans now calibrated to Staff Secure Group Home (10A NCAC 27G) — appropriate level of care for the program
- Cover scope-pill, About-page Service Type/Service Intensity lines, Plan 1 service array, Plan 3 licensure bullet, Plan 5 elopement risk row, Plan 11 staffing patterns/physical environment, Plan 12 screening criteria — all reflect Staff Secure Group Home specifics
- Staffing recalibrated: 1:6 waking (was 1:4), 1:8 overnight (unchanged), LP on-site business hours + on-call 24/7 (was on-site 16h/day), psychiatrist available per PCP schedule + on-call (was on-site + on-call 24/7), RN per health-services schedule + on-call (was on-site/on-call 24/7)
- Physical plant recalibrated: staff-supervised egress (was hardware-secure controlled-egress), door/window alarms as appropriate (was alarmed perimeter + 24-hr video monitoring of common areas), controlled visitor-entry process (was secured visitor-entry vestibule)
- Clinical intensity recalibrated: individual therapy weekly (was 2x/week), group therapy multiple times/week (was daily), family therapy as clinically indicated biweekly minimum (was weekly minimum)
- 12/12 pdf_qa checks PASS, 0 stale Level III RTF/.1703/hardware-secure/controlled-egress references remain (except 2 intentional contrast mentions in Plans 3 and 11)
- Persistent source scripts:
  /home/z/my-project/scripts/patch_carf_plans_v1_2.py — single-pass patch script (18 OK / 0 FAIL)
  /home/z/my-project/scripts/carf_plans_content.py — patched (8 Staff Secure Group Home calibrations applied)
  /home/z/my-project/scripts/generate_carf_plans.py — patched (5 Rev 1.1→1.2 + Service Type/Service Intensity)
